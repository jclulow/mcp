...
typedef struct strset_cursor strset_cursor_t;
...
extern int strset_cursor(strset_t *, strset_cursor_t **);
extern void strset_cursor_free(strset_cursor_t *);
extern const char *strset_cursor_peek(strset_cursor_t *);
extern void strset_cursor_next(strset_cursor_t *);
